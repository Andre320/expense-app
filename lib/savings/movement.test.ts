...
describe("applyMovementToBalance", () => {
  ...
  it("rejects negative amounts", () => {
    expect(() => applyMovementToBalance(100, "DEPOSIT", -1)).toThrow(/non-negative/)
  })
...
describe("movementKindLabel", () => {
  it("maps kinds to labels", () => {
    ...
    expect(movementKindLabel("WITHDRAWAL")).toBe("Withdrawal")
    expect(movementKindLabel("ADJUSTMENT")).toBe("Adjustment")
  })
})
